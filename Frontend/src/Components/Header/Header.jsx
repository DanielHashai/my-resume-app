...
function Header() {
  ...
  return (
    <motion.div initial="hidden" whileInView="show" variants={headerVariants} viewport={{ once: false, amount: 0.25 }} className={`paddings ${css.wrapper}`}
          ...
          <img src="./techlogo.png" alt="" />
              ...
              <ul  style={getMenuStyles(menuOpened)} className= { `flexCenter ${css.menu}`}>
                ...
                <li><a href="#footer">Information</a></li>
                  <li className={ ` flexCenter ${css.phone}`}><a href='tel:+972508260440'><BiPhoneCall size={ "40px"} /> </a></li>
              </ul>
